...
```{r, echo=FALSE, fig.alt: "Bar chart with groups comparing search rates by age group across Charlotte, Chicago, and New Orleans. New Orleans has the highest search rates for minors and young adults, while Chicago has the lowest across all ages."}
